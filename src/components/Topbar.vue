...
<template>
  <div class="flex justify-center gap-20  h-[100px] shadow-md w-full fixed z-10 bg-slate-300 open" hover-class="none" hover-stop-propagation="false">
    ...
    <text class="text-[30px] relative  top-[30px]" selectable="false" space="false" decode="false">
